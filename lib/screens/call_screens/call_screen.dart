...
class _CallScreenState extends State<CallScreen> {
  ...
  Future<void> initializeAgora() async {
    if (APP_ID.isEmpty) {
      setState(() {
        _infoStrings.add(
          'APP_ID missing, please provide your APP_ID in agora_configs.dart',
        );
  ...
  addPostFrameCallback() {
    SchedulerBinding.instance.addPostFrameCallback((_) {
      ...
      callStreamSubscription = callMethods
        ...
        //using switch because it exexutes only once thus no black screen will be shown because of uncontrollable if execution
        switch (ds.data) {
          case null:
